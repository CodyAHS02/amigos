...
export default function OfferCalculator({ embedded = false, defaultFlow = "SELECT", isHomeSplitLayout = false }) {
  ...
  const [selectedCard, setSelectedCard] = useState("SIMPLE");
  const [hoveredCard, setHoveredCard] = useState(null);
  const activeSelectionCard = hoveredCard || selectedCard;
  const isSimpleCardActive = activeSelectionCard === "SIMPLE";
  const isDetailedCardActive = activeSelectionCard === "DETAILED";
  ...
  if (embedded) {
    if (isSelect) {
      return (
        <main className={cx(styles.selectionPage, "offerCalculatorEmbedded")}>
          <div className={styles.selectionHeroContainer}>
            {/* 1. Clean, Spacious & Balanced Header */}
            ...
            {/* 3. Two Interactive Calculator Cards */}
            <div className={styles.selectionTabsGrid}>
              ...
              <div
                ...
                tabIndex={0}
                className={cx(
                  styles.selectionTabCard,
                  isSimpleCardActive ? styles.tabHighlighted : styles.tabSecondary
                )}
              ...
              >
                <div className={styles.tabBadgeRow}>
                  <span
                    className={cx(
                      styles.tabTagPill,
                      isSimpleCardActive ? styles.tabTagGradient : styles.tabTagNeutral
                    )}
                  >
                    <span>⚡</span>
                    <span className={isSimpleCardActive ? styles.tabTagGradientText : undefined}>
                      FOR HOMEOWNERS
                    </span>
                  </span>
                  <span className={styles.tabMetaChip}>⏱ ~2 min estimate</span>
                </div>
                ...
                <ul className={styles.tabFeatureList}>
                  <li className={styles.tabFeatureItem}>
                    <span
                      className={cx(
                        styles.tabFeatureIconBadge,
                        isSimpleCardActive && styles.tabFeatureIconBadgeActive
                      )}
                    >
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path
                          d="M2.5 6.2L4.6 8.5L9.5 3.5"
                          stroke="currentColor"
                          strokeWidth="2"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                ...
                <div className={styles.tabButtonWrapper}>
                  <button
                    ...
                    className={cx(
                      styles.tabActionBtn,
                      isSimpleCardActive ? styles.tabActionBtnGradient : styles.tabActionBtnSecondary
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
                      setState((curr) => ({ ...curr, calculatorType: "SIMPLE" }));
              ...
              <div
                ...
                className={cx(
                  styles.selectionTabCard,
                  isDetailedCardActive ? styles.tabHighlighted : styles.tabSecondary
                )}
                onMouseEnter={() => setHoveredCard("DETAILED")}
                onMouseLeave={() => setHoveredCard(null)}
                onClick={() => {
              ...
              >
                <div className={styles.tabBadgeRow}>
                  <span
                    className={cx(
                      styles.tabTagPill,
                      isDetailedCardActive ? styles.tabTagGradient : styles.tabTagNeutral
                    )}
                  >
                    <span>📐</span>
                    <span className={isDetailedCardActive ? styles.tabTagGradientText : undefined}>
                      FOR PROFESSIONALS
                    </span>
                  </span>
                  <span className={styles.tabMetaChip}>📄 Itemized PDF</span>
                </div>
                ...
                <ul className={styles.tabFeatureList}>
                  <li className={styles.tabFeatureItem}>
                    <span
                      className={cx(
                        styles.tabFeatureIconBadge,
                        isDetailedCardActive && styles.tabFeatureIconBadgeActive
                      )}
                    >
                      <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                        <path
                ...
                <div className={styles.tabButtonWrapper}>
                  <button
                    ...
                    className={cx(
                      styles.tabActionBtn,
                      isDetailedCardActive ? styles.tabActionBtnGradient : styles.tabActionBtnSecondary
                    )}
                    onClick={(e) => {
                      e.stopPropagation();
                      setState((curr) => ({ ...curr, calculatorType: "DETAILED" }));
      ...
      <main className={cx(styles.page, styles.embedded, "offerCalculatorEmbedded")}>
        <aside className={styles.embeddedRail}>
          <div className={styles.heroCopy}>
            ...
            <h1>{isSimple ? "YOUR ESTIMATED QUOTE" : "OFFER CALCULATOR & REQUEST"}</h1>
            <p>
              {isSimple
                ? "Simple. Fast. No obligation. Receive your price after entering your email address."
                : "Calculate, see your price – and request your offer."}
            </p>
            <ul>
              {isSimple ? (
                <>
                  <li>No m² wall or ceiling measurements required</li>
                  <li>Predefined Swiss quality reference calculations</li>
                  <li>Immediate estimate & verified official PDF quote</li>
                </>
              ) : (
                <>
          ...
          <div className={styles.sidebarModeCard}>
            <span className={styles.sidebarModeKicker}>
              {isSimple ? "FOR PROFESSIONALS" : "FOR HOMEOWNERS"}
            </span>
            <h3 className={styles.sidebarModeTitle}>
              {isSimple ? "Detailed Quote Mode" : "Fast Estimate Mode"}
            </h3>
            ...
            <div className={cx(styles.consultationShell, styles.embeddedLeft)}>
              ...
              {step === 0 && (
                <div className={styles.stepPanel}>
                  ...
                  <h2>{isSimple ? "Your Estimated Quote in Just a Few Steps" : "What type of property is it?"}</h2>
                  <p>{isSimple ? "Please select your property type below. No m² calculations needed." : "Please select your property type below."}</p>
